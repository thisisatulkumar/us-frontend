...
export default function Home() {
    ...
    // When someone opens the whiteboard, it fetches the saved strokes and redraws it on the the whiteboard
    useEffect(() => {
    ...
    function formatDate(ts: number) {
        ...
        if (d.toDateString() === yesterday.toDateString()) return "Yesterday " + d.toLocaleTimeString([], { 
            hour: '2-digit', 
            minute: '2-digit' 
        });
    ...
    function startDragWB(e: React.MouseEvent) { 
        dragRef.current.dragging = true; 
        dragRef.current.offsetX = e.clientX - wbPosition.x; 
        dragRef.current.offsetY = e.clientY - wbPosition.y; 

        window.addEventListener("mousemove", dragWB); 
        window.addEventListener("mouseup", stopDragWB); 
    }

    function dragWB(e: MouseEvent) { 
    ...
    function stopDragWB() { 
        ...
        window.removeEventListener("mousemove", dragWB); 
        window.removeEventListener("mouseup", stopDragWB); 
    }
    ...
    // Grouping of chats under a common timestamp would be done according to this time
            ...
            <div className="flex-1 flex flex-col">
                <div className="flex-1 flex justify-center items-center gap-4 p-4">
                    <video 
                        ...
                        muted 
                        playsInline 
                        className="w-1/2 rounded-lg border border-gray-700 shadow-lg" 
                    />
